...
module RedmineParentToChildUpdate
  class Hooks < Redmine::Hook::ViewListener
    ...
    def view_issues_show_details_bottom(context = {})
      ...
      output << ".child-req-field textarea{height:60px;resize:vertical;}"
      ...
      output << "        inp=document.createElement('textarea'); inp.rows=2;"
      output << "        inp.style.cssText='width:100%;padding:5px 8px;font-size:12px;box-sizing:border-box;height:52px;resize:vertical;';"
      output << "        if(initVal) inp.value=initVal;"
      output << "      } else {"
