...
module RedmineChildStatusSync
  module IssuePatch
    ...
    module InstanceMethods
      ...
      # mirrors collect_parent_issues's traversal, just walking downward instead of upward.
      def collect_descendant_issues(root_issue)
        queue = root_issue.children.to_a
        collected = []
        visited_ids = []
        ...
        while issue = queue.shift
          ...
          collected << issue
          queue.concat(issue.children.to_a)
        end
